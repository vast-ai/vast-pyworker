...
export REPORT_ADDR="https://fuzzy-capacity-however-assessed.trycloudflare.com" #needs to be changed manually in the version at the path https://s3.amazonaws.com/vast.ai/start_server.sh
